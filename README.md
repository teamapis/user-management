# Cloud Admin User Management API Spec

> The Cloud Admin User Management API schema over time.

![Atlassian Developer](assets/logo-gradient-blue-developer.png)

The Cloud Admin User Management API documentation is located [here](https://developer.atlassian.com/cloud/admin/user-management/rest/intro/) on the Atlassian Developer website.
